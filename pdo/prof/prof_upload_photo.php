...
<div class="bbody">
    ...
    <!-- upload form -->
    <form id="frm_uf" enctype="multipart/form-data" method="post" action="./prof/upload.php" onsubmit="return checkForm()">
        <!-- hidden crop params -->
        <input type="hidden" id="idprofessors" name="idprofessors" value="<?=$idprofessors?>" />
...
<script type="text/javascript">
    function pujarFoto() {
		$('#frm_uf').form('submit',{  
		    ...
		    $('#resultPhotoDiv').html(result);
                    //open1('./prof/prof_grid.php?page=2',this)
	...
	function esborrarFoto() {
            url = './prof/esborra_foto.php?id=<?=$idprofessors?>';
