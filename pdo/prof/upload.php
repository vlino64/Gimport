...
function uploadImageFile($idprofessors) { // Note: GD library is required for this function
        ...
        if ($_FILES) {
            ...
            if (! $_FILES['image_file']['error'] && $_FILES['image_file']['size'] < 250 * 1024) {
                if (is_uploaded_file($_FILES['image_file']['tmp_name'])) {
					...
					$sTempFileName = '../images/prof/' . $idprofessors;
...
$sImage       = uploadImageFile($idprofessors);
