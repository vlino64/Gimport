...
<tr>
    ...
    <b>Grup</b><br><?= getGrup($db,$idgrup)["nom"] ?><br>
    <b>Mat&egrave;ria</b><br><?= (intval($item['idmateria']!=0) ? getMateria($db,$item['idmateria'])["nom_materia"] : '') ?><br>
    <b>Espai</b><br><?= ($item['idespais']!=0 ? getEspaiCentre($db,$item['idespais'])["descripcio"] : '') ?><br>
