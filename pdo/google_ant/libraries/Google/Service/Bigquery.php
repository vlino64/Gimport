...
class Google_Service_Bigquery extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this["data"]sets = new Google_Service_Bigquery_Datasets_Resource(
        $this,
        $this->serviceName,
        'datasets',
        array(
 ...
 *   $datasets = $bigqueryService["data"]sets;
 *  </code>
 */
...
class Google_Service_Bigquery_Dataset extends Google_Collection
{
  ...
  {
    $this["data"]setReference = $datasetReference;
  }
  public function getDatasetReference()
  {
    return $this["data"]setReference;
  }
