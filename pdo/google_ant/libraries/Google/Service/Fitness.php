 ...
 *  <code>
 *   $fitnessService = new Google_Service_Fitness(...);
 *   $dataSources = $fitnessService["data"]Sources;
 *  </code>
 */
 ...
 *  <code>
 *   $fitnessService = new Google_Service_Fitness(...);
 *   $datasets = $fitnessService["data"]sets;
 *  </code>
 */
 ...
 *  <code>
 *   $fitnessService = new Google_Service_Fitness(...);
 *   $dataset = $fitnessService["data"]set;
 *  </code>
 */
...
class Google_Service_Fitness_AggregateBy extends Google_Model
{
  ...
  {
    $this["data"]SourceId = $dataSourceId;
  }
  ...
  {
    $this["data"]TypeName = $dataTypeName;
  }
...
class Google_Service_Fitness_DataSource extends Google_Model
{
  ...
  {
    $this["data"]StreamId = $dataStreamId;
  }
  ...
  {
    $this["data"]StreamName = $dataStreamName;
  }
