...
class Google_Service_Analytics extends Google_Service
{
  ...
  public function __construct(Google_Client $client)
  {
    ...
    $this["data"]_ga = new Google_Service_Analytics_DataGa_Resource(
        $this,
        $this->serviceName,
        'ga',
        array(
    ...
    $this["data"]_mcf = new Google_Service_Analytics_DataMcf_Resource(
        $this,
        $this->serviceName,
        'mcf',
        array(
    ...
    $this["data"]_realtime = new Google_Service_Analytics_DataRealtime_Resource(
        $this,
        $this->serviceName,
        'realtime',
        array(
