...
$.fn.pagination.defaults={total:1,pageSize:20,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_9f,_a0){
},onBeforeRefresh:function(_a1,_a2){
},onRefresh:function(_a3,_a4){
},onChangePageSize:function(_a5){
},beforePageText:"Pàgina",afterPageText:"de {pages}",displayMsg:"Mostrant {from} fins a {to} de {total} elements",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:1,weeks:["DG","DL","DM","DX","DJ","DV","DS"],months:["Gen","Feb","Mar","Abr","Mai","Jun","Jul","Ago","Set","Oct","Nov","Des"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
}};
})(jQuery);
(function($){
function init(_46f){
