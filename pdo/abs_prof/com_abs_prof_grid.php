...
?>        
	...
	data-options="
		singleSelect: true,
                ...
                rownumbers: true,
		toolbar: '#toolbar',
		url: './abs_prof/com_abs_prof_getdata.php',
	...
	">    
        <thead>  
            <tr>
                ...
                <th field="grup" width="180" sortable="true">Grup</th>
                <th field="materia" width="250" sortable="true">Mat&egrave;ria</th>
                <!--<th field="espaicentre" width="240" sortable="true">Espai</th>-->
                <th data-options="field:'comentari_tasca',width:350,align:'left',editor:{type:'textarea',validType:'length[0,256]'}">Detall tasca</th>
            </tr>  
        </thead>  
    </table> 
    ...
    <div id="toolbar" style="padding:5px;height:auto">  
        ...
        <a id="hores_button" href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="doSearch()">Detallar hores d'abs&egrave;ncia</a>
        &nbsp;
        <a id="add_button" href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="comunicacioAbsencia(1,<?=TIPUS_FALTA_PROFESSOR_ABSENCIA?>)">Comunicar abs&egrave;ncia</a>
    ...
    <script type="text/javascript">  
		...
		function comunicacioAbsencia(afegir,tipus_incident){
		    ...
		    if (rows){ 
			   ...
			   url = './abs_prof/com_abs_prof_edita.php';
