...
foreach (glob($sTempFileName_noextension."*.*") as $filename) {
	...
	$link = "http://".$_SERVER['SERVER_NAME'].substr($_SERVER['PHP_SELF'],0,strlen($_SERVER['PHP_SELF'])-31).substr($fitxer_tasca,3,strlen($fitxer_tasca)-2);
}
?>
...
<tr>
    ...
    <b>Detalls tasca</b><br><?= $item['comentari_tasca'] ?><br>
    </td>
</tr>
</table>
