...
<div class="bbody">
    ...
    <!-- upload form -->
    <form id="frm_uf" enctype="multipart/form-data" method="post" action="./dades_centre/upload.php" onsubmit="return checkForm()">
        <!-- hidden crop params -->
        ...
        <input class="formulari" type="file" name="image_file" id="image_file" onchange="fileSelectHandler()" />        
        </div>
        ...
        <div class="step2">
            ...
            <tr>
                ...
                <th valign="bottom">
                    Resultat
                    <div id="resultPhotoDiv" style="border:1px dashed #666666; width:150px; height:40px">
                    </div>
                </th>
            </tr>
...
<script type="text/javascript">
	...
	function esborrarFoto() {
		url = './dades_centre/esborra_foto.php';
