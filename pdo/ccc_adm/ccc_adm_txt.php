                ...
                <?php
				   $linea = 1;
				    foreach($rec->fetchAll() as $row) {
						  ...
						  echo "<td class='drop' valign='top'>".getLiteralTipusCCC($db,$row["id_falta"])["nom_falta"]."</td>";
						  echo "<td class='drop' valign='top'>".substr($row["data"],8,2)."-".substr($row["data"],5,2)."-".substr($row["data"],0,4)."</td>";
						  echo "<td class='drop' valign='top'>".$row["expulsio"]."</td>";
						  echo "<td class='drop' valign='top'>".getAlumne($db,$row["idalumne"],TIPUS_nom_complet)."</td>";
						  echo "<td class='drop' valign='top'>".getProfessor($db,$row["idprofessor"],TIPUS_nom_complet)."</td>";
						  echo "<td class='drop' valign='top'>".(intval($row["idmateria"]!=0) ? getMateria($db,$row["idmateria"])["nom_materia"] : '')."</td>";
						  echo "<td class='drop' width='250' valign='top'><strong>Desc. breu</strong><br>".getLiteralMotiusCCC($db,$row["id_motius"])["nom_motiu"];
