...
$sql .= "WHERE data BETWEEN '".$data_inici."' AND '".$data_fi."'";
...
$sql .= "WHERE ca.id_tipus_contacte=".TIPUS_nom_complet." AND cp.id_tipus_contacte=".TIPUS_nom_complet." AND tp.data BETWEEN '".$data_inici."' AND '".$data_fi."' ";
