...
$sql  = "SELECT id_falta,expulsio,id_motius,descripcio_detallada,id_tipus_sancio,idgrup,idmateria,idespais, ";
$sql .= "CONCAT(SUBSTR(data,9,2),'-',SUBSTR(data,6,2),'-',SUBSTR(data,1,4)) AS data_incident, ";
$sql .= "CONCAT(SUBSTR(data_inici_sancio,9,2),'-',SUBSTR(data_inici_sancio,6,2),'-',SUBSTR(data_inici_sancio,1,4)) AS data_inici_sancio, ";
...
$items = array('id_falta' => '','expulsio' => '','id_motius' => '','descripcio_detallada' => '',
			   'id_tipus_sancio' => '','idgrup' => '','idmateria' => '','idespais' => '',
			   'data_inici_sancio' => '','data_fi_sancio' => '');
