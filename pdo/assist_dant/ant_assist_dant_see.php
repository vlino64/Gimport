		...
		<table>
         	<tr>
			   ...
			   $linea = 1;
				  ...
				  echo "<td valign='top' width='350' class='drop'>".$row["Valor"]."</td>";
				  echo "<td valign='top' width='70' class='drop'>".getTotalIncidenciasAlumne($db,$row["idalumnes"],TIPUS_FALTA_ALUMNE_ABSENCIA,$data_inici,$data_fi)."</td>";
				  echo "<td valign='top' width='80' class='drop'>".getTotalIncidenciasAlumne($db,$row["idalumnes"],TIPUS_FALTA_ALUMNE_RETARD,$data_inici,$data_fi)."</td>";
				  echo "<td valign='top' width='80' class='drop'>".getTotalIncidenciasAlumne($db,$row["idalumnes"],TIPUS_FALTA_ALUMNE_JUSTIFICADA,$data_inici,$data_fi)."</td>";
				  ...
				  echo "<td valign='top' width='80' class='drop'>".getTotalCCCAlumne($db,$row["idalumnes"],$data_inici,$data_fi)."</td></tr>";
				  $linea++;
                           }
		?>          
		</table>
    ...
    <tr>
            ...
            <tr>
                ...
                <?php
				   ...
				   $rsIncidencias = getIncidenciasAlumne($db,$c_alumne,TIPUS_FALTA_ALUMNE_ABSENCIA,$data_inici,$data_fi);
						  ...
						  echo "<td valign='top' width='80' class='drop'>".substr($db,getFranjaHoraria($db,$row["idfranges_horaries"])["hora_inici"],0,5)."-".substr($db,getFranjaHoraria($db,$row["idfranges_horaries"])["hora_fi"],0,5)."</td>";
        ...
        <h5>Relaci&oacute; de incid&egrave;ncies</h5>
 		<table>
            <tr>
                <td>&nbsp;</td>
                <td><strong>TIPUS INCIDENT</strong></td>
                <td><strong>DATA</strong></td>
                <td><strong>F. HOR&Agrave;RIA</strong></td>
                <td><strong>PROFESSOR/A</strong></td>
                <td><strong>MAT&Egrave;RIA</strong></td>
