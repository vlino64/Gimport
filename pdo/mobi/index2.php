<?php
	...
	$client_id = '790252865917-sh6h2d78qkqa3i87sp1v3bs9l2hg9spg.apps.googleusercontent.com'; 
	$client_secret = '1PQxdeyjAVEmqTpDdWc5MxhG';
	$redirect_uri = 'https://gassist.copernic.cat/login_google.php';
        $hosting        = '1';
