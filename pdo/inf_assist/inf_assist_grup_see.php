...
<style type="text/css">
 ...
 <?php
  ...
  Grup 
  <input id="idgrup" name="idgrup" class="easyui-combobox" style="width:320px" data-options="required:false,panelWidth:320">
  <br /><br />
 ...
 <table>
    ...
    <tr>
    	<td class='drop'>&nbsp;</td>
        <td class='drop'>&nbsp;</td>
        <td class='drop'><?=getTotalIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_ABSENCIA,$data_inici,$data_fi)?></td>
        <td class='drop'><?=getTotalIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_RETARD,$data_inici,$data_fi)?></td>
        <td class='drop'><?=getTotalIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_JUSTIFICADA,$data_inici,$data_fi)?></td>
        <td class='drop'><?=getTotalIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_SEGUIMENT,$data_inici,$data_fi)?></td>
        <td class='drop'><?=$totalCCC?></td>
    </tr>
 </table>
 <br />
 <?php
 ...
 <table>
    ...
    <?php
		...
		foreach($rsEquipDocent->fetchAll() as $row) {
			...
			echo "<td valign='top' ".$isActivat.">".HoresSetmanals($db,$idgrup,$row["codi_materia"])."</td>";
			echo "<td valign='top' ".$isActivat.">".getTotalIncidenciasProfessorGrupMateria($db,$row["idprofessors"],$idgrup,$row["codi_materia"],TIPUS_FALTA_ALUMNE_ABSENCIA,$data_inici,$data_fi)."</td>";
			echo "<td valign='top' ".$isActivat.">".getTotalIncidenciasProfessorGrupMateria($db,$row["idprofessors"],$idgrup,$row["codi_materia"],TIPUS_FALTA_ALUMNE_RETARD,$data_inici,$data_fi)."</td>";
			echo "<td valign='top' ".$isActivat.">".getTotalIncidenciasProfessorGrupMateria($db,$row["idprofessors"],$idgrup,$row["codi_materia"],TIPUS_FALTA_ALUMNE_JUSTIFICADA,$data_inici,$data_fi)."</td>";
			echo "<td valign='top' ".$isActivat.">".getTotalIncidenciasProfessorGrupMateria($db,$row["idprofessors"],$idgrup,$row["codi_materia"],TIPUS_FALTA_ALUMNE_SEGUIMENT,$data_inici,$data_fi)."</td>";
			echo "<td valign='top' ".$isActivat.">".getTotalCCCProfessorGrup($db,$row["idprofessors"],$idgrup,$row["codi_materia"],$data_inici,$data_fi)."</td>";
			echo "</tr>";
			$linea++;
		}
	?>
    ...
    <tr>
        ...
        <td class='drop'><?=getTotalIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_JUSTIFICADA,$data_inici,$data_fi)?></td>
        <td class='drop'><?=getTotalIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_SEGUIMENT,$data_inici,$data_fi)?></td>
        <td class='drop'><?=getTotalCCCGrup($db,$idgrup,$data_inici,$data_fi)?></td>
    </tr>
 </table>
 <br />
 <?php
 ...
 <table>
            <tr>
                ...
                <?php
				   $linea         = 1;
				   $rsIncidencias = getIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_ABSENCIA,$data_inici,$data_fi);
  ...
  <table>
            <tr>
                ...
                <?php
				   $linea         = 1;
				   $rsIncidencias = getIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_RETARD,$data_inici,$data_fi);
				   foreach($rsIncidencias->fetchAll() as $row) {
						  echo "<tr>";
						  echo "<td valign='top' width='30'>".$linea."</td>";
						  echo "<td valign='top' width='90' class='drop'>".substr($row["data"],8,2)."-".substr($row["data"],5,2)."-".substr($row["data"],0,4)."</td>";
  ...
  <table>
            <tr>
                ...
                <?php
				   $linea         = 1;
				   $rsIncidencias = getIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_JUSTIFICADA,$data_inici,$data_fi);
				   foreach($rsIncidencias->fetchAll() as $row) {
						  echo "<tr>";
						  echo "<td valign='top' width='30'>".$linea."</td>";
						  echo "<td valign='top' width='90' class='drop'>".substr($row["data"],8,2)."-".substr($row["data"],5,2)."-".substr($row["data"],0,4)."</td>";
  ...
  <table>
            <tr>
                ...
                <?php
				   $linea         = 1;
				   $rsIncidencias = getIncidenciasGrup($db,$idgrup,TIPUS_FALTA_ALUMNE_SEGUIMENT,$data_inici,$data_fi);
				   foreach($rsIncidencias->fetchAll() as $row) {
						  echo "<tr>";
						  ...
						  echo "<td valign='top' width='50' class='drop'>".getAlumne($db,$row["idalumnes"],TIPUS_nom_complet)."</td>";
            ...
            <tr>
                ...
                <td><strong>DESCRIPCI&Oacute;</strong></td>
				   ...
				   $linea         = 1;
						  ...
						  echo "<td valign='top' width='50' class='drop'>".getAlumne($db,$row["idalumne"],TIPUS_nom_complet)."</td>";
