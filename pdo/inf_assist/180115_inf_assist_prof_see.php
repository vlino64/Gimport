...
<script type="text/javascript">  		
	...
	function myparser(s){  
		...
		function doSearch(idprofessor){  
			...
			url = './inf_assist/inf_assist_prof_see.php?data_inici='+d_inici+'&data_fi='+d_fi+'&idgrup='+idgrup+'&idprofessor='+idprofessor+'&idgrup='+idgrup+'&c_alumne='+c_alumne+'&c_materia='+c_materia+'&mode_impresio=1';
		...
		function imprimirPDF(idprofessor){  
			...
			url  = './inf_assist/inf_assist_prof_print.php?data_inici='+d_inici+'&data_fi='+d_fi+'&idgrup='+idgrup+'&idprofessor='+idprofessor+'&idgrup='+idgrup+'&c_alumne='+c_alumne+'&c_materia='+c_materia+'&mode_impresio=1';
		...
		function imprimirWord(idprofessor){  
			...
			url  = './inf_assist/inf_assist_prof_print_word.php?data_inici='+d_inici+'&data_fi='+d_fi+'&idgrup='+idgrup+'&idprofessor='+idprofessor+'&idgrup='+idgrup+'&c_alumne='+c_alumne+'&c_materia='+c_materia+'&mode_impresio=1';
			url += '&box_al='+box_al+'&box_faltes='+box_faltes+'&box_retards='+box_retards;
			url += '&box_justificacions='+box_justificacions+'&box_incidencies='+box_incidencies+'&box_CCC='+box_CCC;
		...
		function imprimirExcel(idprofessor){  
			...
			url  = './inf_assist/inf_assist_prof_print_excel.php?data_inici='+d_inici+'&data_fi='+d_fi+'&idgrup='+idgrup+'&idprofessor='+idprofessor+'&idgrup='+idgrup+'&c_alumne='+c_alumne+'&c_materia='+c_materia+'&mode_impresio=1';
			url += '&box_al='+box_al+'&box_faltes='+box_faltes+'&box_retards='+box_retards;
			url += '&box_justificacions='+box_justificacions+'&box_incidencies='+box_incidencies+'&box_CCC='+box_CCC;
	...
	$('#idgrup').combobox({
		...
		onSelect: function(date){
			...
			textField  : 'Valor'					
                    ...
                    $('#c_materia').combobox({
			url:'./tutor/materies_prof_getdata.php?idgrups='+idgrup+'&idprofessors=<?=$idprofessor?>',
