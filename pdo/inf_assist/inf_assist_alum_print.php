...
$fitxer_sortida  = "http://".$_SERVER['SERVER_NAME'].substr($_SERVER['PHP_SELF'],0,strlen($_SERVER['PHP_SELF'])-25)."inf_assist_alum_see.php?hr=1&data_inici=";
$fitxer_sortida .= $data_inici."&data_fi=".$data_fi."&idalumne=".$idalumne."&mode_impresio=".$mode_impresio;
$fitxer_sortida .= "&box_faltes=".$box_faltes."&box_retards=".$box_retards;
