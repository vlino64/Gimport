...
$hora               = getFranjaHoraria($db,$idfranges_horaries)["hora_inici"];
...
/*$sql .= " AND NOT agm.idalumnes IN (SELECT sa.id_alumne ";
$sql .= "FROM sortides_alumne sa ";
$sql .= "INNER JOIN sortides s ON sa.id_sortida = s.idsortides ";
$sql .= "WHERE s.data_inici<='".$data."' AND s.data_fi>='".$data."'";
