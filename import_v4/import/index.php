...
<table class="general" width="70%" align="center" bgcolor="#ffbf6d" >
	<tr><td align="center"><div id="subgeisoft3" style="display:none;">
                    <p> Indica el que vulguis fer ( <b>Si no disposes de programa de generació d'horaris, no has de carregar res en aquesta pàgina.<br>Selecciona la primera opció </b></p>
