...
function mostrarReferencia5()
	...
	document.getElementById('subgeisoft1').style.display='block';
	document.getElementById('subgeisoft5').style.display='block';
	if (document.fcontacto.carrega3[1].checked == true)
		{
		document.getElementById('subgeisoft2').style.display='block';
		document.getElementById('subgeisoft4').style.display='none';
		}
...
<table class="general" width="70%" align="center"bgcolor="#ffbf6d" >
	<tr><td align="center"><p>Utilitzes la gestió centralitzada d'usuaris de GEISoft <br>i altres eines apart de la gestió de l'assistència?:<br /></td></tr>
        <tr><td align="center"><p><b><font color = "blue">Per poder seguir has de tenir tot el professorat actualitzat a la gestió centralitzada</b></font> <br></td></tr>
...
<table class="general" width="70%" align="center" bgcolor="#ffbf6d">
	...
	<p> ----------------------------------------------------------</p>
   <input type="radio" name="carrega" value="0" id="carrega_0" onclick="mostrarReferencia3()" > <b>Centre que s'incorpora el curs 17/18</b>. Mai he utilitzat gassist <br>
	<input type="radio" name="carrega" value="1" id="carrega_1" onclick="mostrarReferencia3()" > <b>Centre incorporat abans del curs 17/18</b>. Ja he utilitzat gassist, però és un curs nou<br>
   ...
   <input type="radio" name="carrega" value="3" id="carrega_3" onclick="mostrarReferencia3()" > <b>Actualitzar alumnat.</b> Completar informació alumnat del fitxer de CENTRE<br>
<!--
   ---------------------------------------------------------------------------<br>
...
<p> Carrega el fitxer de SAGA</p>
<input type="radio" name="carrega2" value="1" id="carrega_0" onclick="mostrarReferencia4()" > <b>Utilitzar un fitxer de CENTRE carregat prèviament. </b> 
...
<br>
<input type="radio" name="carrega2" value="0" id="carrega_1" onclick="mostrarReferencia4()" > <b>Carregar un fitxer nou de CENTRE</b>. Ja he utilitzat gassist, però és un curs nou<br>
</div></td></tr>
</table>

<table class="general" width="70%" align="center" bgcolor="#ffbf6d" >
	<tr><td align="center"><div id="subgeisoft5" style="display:none;">
<p> Carrega el fitxer csv dels alumnes</p>
<input type="radio" name="carrega3" value="1" id="carrega_4" onclick="mostrarReferencia4()" > <b>Utilitzar un fitxer d'alumnes carregat prèviament. </b> 
...
<br>
<input type="radio" name="carrega2" value="0" id="carrega_5" onclick="mostrarReferencia4()" > <b>Carregar un fitxer nou d'alumnes</b>. Ja he utilitzat gassist, però és un curs nou<br>
</div></td></tr>
</table>
