...
<table class="general" width="70%" align="center" bgcolor="#ffbf6d">
   ...
   <input type="radio" name="carrega" value="3" id="carrega_3" onclick="mostrarReferencia5()" > <b>Actualitzar alumnat.</b> Completar informació alumnat de SAGA<br>
	---------------------------------------------------------------------------<br>
...
<table class="general" width="70%" align="center" bgcolor="#ffbf6d" >
	...
	<input name="boton" type="submit" id="boton" value="Actualitza alumnat">
</div></td></tr>
</table>
