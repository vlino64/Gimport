...
<?php
        ...
        for ($i=1;$i<=$recompte;$i++)
            ...
            $id=extreu_id('alumnes','codi_alumnes_saga','idalumnes',$id_saga,$db);
            //echo "<br>".$id;
            ...
            carrega_dades_families($id,$id_saga,$db);
            ...
            if($_POST[$alta])
                ...
                if ($id_grup != 0)
                    ...
                    foreach ($result->fetchAll() as $fila)
                        {
                        $sql2 = "INSERT INTO alumnes_grup_materia(idalumnes,idgrups_materies) VALUES ('".$id."','".$fila['idgrups_materies']."');";
                        //echo "<br>".$sql2;
