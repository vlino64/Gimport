...
<?php
    ...
    //@@@@@@@@@@@@@@@@@2
    // Carreguem les parelles del nom i el codi del programa d'horaris a a taula d'equivalències
    //echo $exporthorarixml;
       // ************************************************************
    
    // ************************************************************
    
    intro_prof_equivalencies_gp($exportsagaxml,$exporthorarixml);
...
//	//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@22
	...
	// @@@@@@@@@@@@@@@@@@@@@@@
	// BLOC GENERACIÓ HISTÒRIC
	// @@@@@@@@@@@@@@@@@@@@@@@
    
   
    if ((extreu_fase('carrega')==1)&&(!extreu_fase('segona_carrega')))
        {		
        if (extreu_fase('historic')==0)
            {
            genera_historic();
            }
        else
            ...
            print("&nbsp;&nbsp;	La informació històrica ja ha estat actualitzada.<br>");
            ...
            print("<sub><a href=\"../uploads/historics_".$darrera_data.".csv\">Descarrega't el csv amb absències, retards i incidents</a></sub><br>");
            if (file_exists('../../tutoria/ccc'))
               {print("<sub><a href=\"../uploads/CCC_".$darrera_data.".csv\">Descarrega't el csv amb les CCC del curs passat</a></sub><br>");}
            if (file_exists('../../tutoria/abs_prof'))
               {print("<sub>S'ha fet una cópia de les sortides i absències de professorat<br><br>");}
            }
			}
...
if (!$callipolis)
   ...
   if (extreu_fase('app_horaris')==5)
      ...
      if (!extreu_fase('assig_alumnes'))
         ...
         print("<form method=\"post\" action=\"./main_assignacio_alumnes.php\" enctype=\"multipart/form-data\" id=\"profform\">");
      ...
      if (extreu_fase('modalitat_fitxer')==0)
         ...
         if (!extreu_fase('assig_alumnes'))
            {
            print("<br><img src=\"../images/unchecked.gif\">&nbsp;<input type=button onClick=\"location.href='./main_assignacio_alumnes.php'\" value=\"7. Assigna els alumnes a grups-matèries\" ><br>");
